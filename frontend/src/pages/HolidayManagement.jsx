...
const HolidayManagement = () => {
    ...
    const exportToExcel = () => {
        if (filteredHolidays.length === 0) return alert("Không có dữ liệu để xuất!");
                    ...
                    <table className="w-full text-left border-collapse min-w-[800px]">
                        <thead className="sticky top-0 z-10 bg-[#3b82f6] text-white shadow-sm">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-base font-semibold w-[30%]">Nội Dung Ngày Nghỉ</th>
                                <th className="px-6 py-4 text-base font-semibold">Số Ngày Nghỉ</th>
                                <th className="px-6 py-4 text-base font-semibold w-[30%]">Ghi Chú</th>
                            ...
                            {filteredHolidays.length > 0 ? (
                                filteredHolidays.map((item, index) => (
                                    <tr key={item._id} className="hover:bg-blue-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-base font-semibold text-blue-700 whitespace-pre-wrap leading-relaxed">{item.content}</td>
                                        <td className="px-6 py-4 text-base font-[450] text-[#0a0a0a]">{item.daysCount} ngày</td>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:border-[#2453c9] focus:ring-1 focus:ring-[#2453c9] outline-none transition-all" 
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:border-[#2453c9] focus:ring-1 focus:ring-[#2453c9] outline-none resize-none transition-all" 
                                />
                            </div>
